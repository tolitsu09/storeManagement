...
<body class="font-sans antialiased bg-white">
    ...
    <nav class="container mx-auto py-4 px-4 lg:px-8">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center">
                <a href="#" class="text-black font-bold text-2xl">SHOP.CO</a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-8 ml-8">
                ...
                <a href="#" class="text-gray-800 hover:text-black font-medium">On Sale</a>
                <a href="#" class="text-gray-800 hover:text-black font-medium">New Arrivals</a>
                <a href="#" class="text-gray-800 hover:text-black font-medium">Brands</a>
            </div>            <!-- Search and Icons -->
            <div class="flex items-center space-x-4">
                <!-- Search bar -->
                <div class="hidden md:flex items-center relative">
                    <div class="relative flex items-center">
                        <input type="text" placeholder="Search for products..." class="bg-gray-100 rounded-full pl-10 pr-4 py-2 w-64 focus:outline-none text-sm" />
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 absolute left-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @auth
                <div class="relative group">
                    <button class="text-black flex items-center focus:outline-none" id="profileMenuButton">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </button>
                    <div class="hidden group-hover:block absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
                        <a href="{{ route('profile') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Profile</a>
                        <a href="{{ route('profile') }}#edit-password" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Edit Password</a>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col md:flex-row gap-6 md:gap-8 justify-center items-stretch">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-6 flex-1 min-w-[260px] max-w-sm">
                    ...
                    <div class="text-gray-500 text-sm">“I'm blown away by the quality and style of the clothes I received from Shop.co. From casual wear to elegant dresses, every piece I've bought has exceeded my expectations.”</div>
                </div>
                <!-- Testimonial 2 -->
                <div class="bg-white border border-gray-200 rounded-2xl p-6 flex-1 min-w-[260px] max-w-sm">
                    <div class="flex items-center mb-2">
                    ...
                    <div class="text-gray-500 text-sm">“Finding clothes that align with my personal style used to be a challenge until I discovered Shop.co. The range of options they offer is truly remarkable, catering to a variety of tastes and occasions.”</div>
                </div>
                <!-- Testimonial 3 -->
                <div class="bg-white border border-gray-200 rounded-2xl p-6 flex-1 min-w-[260px] max-w-sm">
                    <div class="flex items-center mb-2">
                    ...
                    <div class="text-gray-500 text-sm">“As someone who's always on the lookout for unique fashion pieces, I'm thrilled to have stumbled upon Shop.co. The selection of clothes is not only diverse but also on-point with the latest trends.”</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row md:justify-between gap-12">
                <div class="md:w-1/4 mb-8 md:mb-0">
                    <div class="text-2xl font-black mb-4">SHOP.CO</div>
    ...
    <script>
                // Show/hide dropdown on click for accessibility
